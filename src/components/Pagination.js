...
const Pagination = () => {
  ...
  const [paginateFirst, { data: dataFirst, error: errorFirst }] = useLazyQuery(PAGINATE_FIRST_EMPLOYEE, {
    fetchPolicy: "cache-and-network",
  });
  const [paginateLast, { data: dataLast, error: errorLast }] = useLazyQuery(PAGINATE_LAST_EMPLOYEE, {
    fetchPolicy: "cache-and-network",
  });
